          ...
          <View style={styles.container}>
            ...
            <View style={styles.center}>
              ...
              {newMes.type === 0 ?
                ...
                newMes.type === 1 ?
                <Text style={styles.last_chat}>{newMes?.text ? conversation.name ? mess(userName + ': ' + "Hình ảnh") : mess("Hình ảnh") : 'Chưa có tin nhắn'}</Text>:
                newMes.type === 1 ?
                <Text style={styles.last_chat}>{newMes?.text ? conversation.name ? mess(userName + ': ' + "Video") : mess("Video") : 'Chưa có tin nhắn'}</Text>:
                <Text style={styles.last_chat}>{newMes?.text ? conversation.name ? mess(userName + ': ' + "File") : mess("File") : 'Chưa có tin nhắn'}</Text>
              }
            </View>
